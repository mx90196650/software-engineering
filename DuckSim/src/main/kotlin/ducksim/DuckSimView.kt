...
class DuckSimView(private val duckPond: DuckPond) : JPanel() {
    ...
    val rectangleList = listOf<Rectangle>(
        Rectangle(150, 300, 100, 100), // rectangle for duck 0
        Rectangle(275, 300, 100, 100), // rectangle for duck 1
        Rectangle(400, 300, 100, 100), // rectangle for duck 2
        Rectangle(525, 300, 100, 100), // rectangle for duck 3
