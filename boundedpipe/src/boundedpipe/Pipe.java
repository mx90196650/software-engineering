...
public interface Pipe<E> extends Iterable<E> {
     ...
     * </p>
     * @param element the element to be appended at the head of the pipe
     ...
     * </p>
     *
     * @param element the element to be appended at the tail of the pipe
     * @throws IllegalStateException if the pipe is full
     * @throws IllegalArgumentException if the specified element is null
     */
     ...
     * </p>
     *
     * @return the result whether the pipe is empty
     */
    boolean isEmpty();
     ...
     * </p>
     *
     * @return the result whether the pipe is full
     */
    boolean isFull();
     ...
     * @throws IllegalStateException when the pipe is full
     * @throws IllegalArgumentException if the that pipe is null
     */
     ...
     * </p>
     *
     * @return the new pipe copied from this pipe
     */
    Pipe<E> copy();
